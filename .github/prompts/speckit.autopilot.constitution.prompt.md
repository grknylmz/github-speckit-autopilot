Merge autopilot behavioral guidelines into the project constitution. These guidelines reduce common LLM coding mistakes and are enforced during task generation and validation.

## Steps

### 1. Locate Constitution File

The constitution file is at `.specify/constitution.md` (or `/memory/constitution.md` depending on project setup). Check both locations.

If no constitution file exists, create one at `.specify/constitution.md`.

### 2. Check for Existing Autopilot Section

Read the constitution file and check for this marker:
...
To refresh: remove the marked section and re-attach this prompt.
```
...
These guidelines will now be enforced during task generation and validation.
